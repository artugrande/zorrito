...
export const ZORRITO_FOX_NFT_ABI = [
  {
    "inputs": [
      {
    ...
    "outputs": [
      {
        ...
        "internalType": "struct ZorritoFoxNFT.Fox",
        "name": "",
        "type": "tuple"
      }
    ],
...
// ZorritoYieldEscrow ABI - Complete ABI from deployed contract
export const ZORRITO_YIELD_ESCROW_ABI = [
  {
    "inputs": [
      {
        "internalType": "address",
  ...
  },
  {
    ...
    "outputs": [
      {
        "internalType": "contract ZorritoFoxNFT",
        "name": "",
        "type": "address"
      }
    ],
...
// ERC20 ABI for CELO token approval
